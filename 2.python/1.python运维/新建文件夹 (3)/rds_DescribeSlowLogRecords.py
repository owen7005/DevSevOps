#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# @Time    : 2018-12-12 16:21
# @Author  : opsonly
# @Site    : 
# @File    : rds_DescribeSlowLogRecords.py
# @Software: PyCharm
...
class RDS_SLOW_LOG(object):

    def __init__(self):
        self.access_id = 'xxxxxxxx'
        self.access_key = 'xxxxxxxxxxxxx'
    ...
    def signed(self):
        ...
        header = {
            ...
            'DBInstanceId': 'xxxxxxxxxxxx',#阿里云rds实例
