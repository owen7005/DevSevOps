#!/bin/bash
# Version: 1.1
# A padding oracle flaw was found in the Secure Sockets Layer version 2.0 (SSLv2) protocol.
# An attacker could potentially use this flaw to decrypt RSA-encrypted cipher text from a connection using a newer SSL/TLS protocol version, allowing them to decrypt such connections.
